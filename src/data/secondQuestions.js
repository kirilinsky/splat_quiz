    ...
    answers: [
      {
        ...
        description:
          'Отлично! Ополаскиватель можно использовать и после чистки зубов, и после каждого приема пищи. Ополаскиватель очищает слизистую рта от патогенных бактерий, помогает удалить остатки пищи в труднодоступных местах полости рта, укрепить зубную эмаль, снизить риск развития кариеса и заболеваний десен. Это средство подойдет и в случае, если у вас стоят брекет-системы, коронки, имплантаты или мостовидные протезы.',
        correctAnswer: true,
        neutral: true,
        status: false,
        sensitivity: 0,
      ...
      },
      {
        ...
        answer: 'Зубная нить',
        description:
          'Все правильно! Зубная нить помогает мягко и эффективно очистить межзубные промежутки от остатков пищи и при регулярном использовании уменьшает образование зубного налета, снижает риск развития кариеса и заболеваний десен. Если у вас стоят брекет-системы, коронки, имплантаты или мостовидные протезы — воспользуйтесь ирригатором для удаления остатков пищи и гидромассажа десен.',
      ...
      },
      {
        ...
        neutral: true,
        description:
          'Отлично! Очищающая пенка помогает быстро удалить мягкий зубной налет после каждого приема пищи и насыщает эмаль зубов кальцием, снижая риск образования кариеса. Кроме того, пенка помогает нормализовать Ph слюны. Это средство ухода подойдет и в случае, если у вас стоят брекет-системы, коронки, имплантаты или мостовидные протезы.',
        correctAnswer: true,
        status: false,
        sensitivity: 0,
        caries: 0,
      ...
      },
      {
        ...
        neutral: true,
        description:
          'Все правильно! Межзубные ершики — инструменты гигиены полости рта, которые используются для очистки межзубных промежутков. Ершики помогают удалить налет и бактерии, снижая риск образования зубного камня и развития кариеса. Также ершики мягко массируют десны и улучшают кровообращение в полости рта. Важно правильно подобрать размер ершика, чтобы защитить десны от травм и избежать повреждения эмали зубов.',
        correctAnswer: true,
        status: false,
        sensitivity: 0,
        caries: 0,
      ...
      },
      {
        ...
        neutral: true,
        description:
          'Такие средства помогают улучшить внешний вид зубов — восстановить белизну эмали,  удалить налет и пятна. Но отбеливающие средства стоит применять умеренно. В их состав может входить активированный уголь, ферменты, а также агрессивные вещества — например, пероксиды, которые повышают чувствительность зубов. Поэтому после отбеливающего курса стоматологи рекомендуют использовать укрепляющие средства с кальцием.',
        correctAnswer: true,
        status: false,
        sensitivity: 1,
        caries: 0,
      ...
      },
      {
        ...
        neutral: true,
        description:
          'Отлично! Это один из инновационных способов заботы о здоровье зубов. Фтор, кальций и фосфаты в составе геля помогают восстановить и укрепить зубную эмаль, снижая риск развития кариеса. Кроме того, регулярное использование геля улучшает внешний вид зубов, безопасным образом придавая эмали более белый оттенок.',
        correctAnswer: true,
        status: false,
        sensitivity: 0,
        caries: 0,
      ...
      },
      {
        ...
        neutral: true,
        description:
          'Прекрасный выбор! Ирригатор —  устройство, которое с помощью струи воды под давлением массирует десны и очищает зубы от налета и остатков пищи, в том числе, в труднодоступных местах полости рта. Регулярное применение ирригатора способствует профилактике кариеса. Устройство подойдет для использования  и в случаях, если у вас стоят брекет-системы, коронки, имплантаты или мостовидные протезы.',
        correctAnswer: true,
        status: false,
        sensitivity: 0,
        caries: 0,
      ...
      },
      {
        ...
        description:
          'Попробуйте!  Это крокодилы и кролики способны менять зубы в течение жизни, а люди — нет. Дополнительные средства гигиены помогут сохранить зубы здоровыми как можно дольше. Зубная нить и ершики помогают избавиться от остатков пищи в межзубных промежутках. Ополаскиватель очищает от патогенных бактерий слизистую оболочку полости рта. Очищающая пенка помогает нормализовать рН слюны. Ирригатор рекомендован, если у вас стоят брекет-системы, коронки, имплантаты или мостовидные протезы. ',
        correctAnswer: false,
        status: false,
        sensitivity: 1,
        caries: 1,
    ...
    answers: [
      {
        ...
        answer: 'да, часто',
        description:
        'Курение сильно вредно для здоровья зубов и десен. Оно изменяет состав слюны, что может привести к болезням зубов и десен, а также увеличить риск развития кариеса и воспаления десен. Чтобы минимизировать вред от курения, рекомендуем использовать очищающую пенку! Пенка сможет снизить негативный эффект от курения и нормализовать состав слюны.',
        correctAnswer: false,
        status: false,
        sensitivity: 1,
        caries: 1,
      ...
      },
      {
        ...
        answer: 'нет',
        description:
          'Так держать! Отсутствие контакта с дымом табака позволяет сохранять здоровые зубы и десны на протяжении жизни. ',
        correctAnswer: true,
        status: false,
        sensitivity: 0,
        caries: 0,
