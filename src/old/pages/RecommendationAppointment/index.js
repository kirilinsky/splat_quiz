...
const RecommendationAppointment = () => {
  const ToothpasteIndex = useSelector(
    (state) => state.number.recommendationValue
  )
  ...
  return (
    <>
      <div className="container">
        <h2 className="splat-title">Оценка состояния полости рта</h2>
      </div>
      <div className="container">
        <div
      ...
      {ToothpasteRecommendation[ToothpasteIndex].length !== 0 && (
        <div className="container">
          <div className="recommendation-block">
            <section>
              <p>Посмотрите, какие продукты рекомендованы именно вам!</p>
              <img src={image} alt="" />
            </section>
            <button onClick={() => dispatch(recommendationProducts())}>
...
export default RecommendationAppointment
